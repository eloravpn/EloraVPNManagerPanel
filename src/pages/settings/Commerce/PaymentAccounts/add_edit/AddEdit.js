      ...
      {({ setFieldValue, values }) => (
        <Form>
          <Grid container spacing={2}>
            <Grid item xs={12}>
              {!!values.user_id && (
                <UserInfo user={user} isLoading={isLoadingUser} showAccount={false}></UserInfo>
              )}
            ...
            <Grid item xs={12} md={6}>
              <TextField name="min_payment_for_bot" label="Minimum Payment for Bot" type="number" />
            </Grid>

            <Grid item xs={12} md={12}>
              <TextField name="shaba" label="Shaba Number" />
            </Grid>
